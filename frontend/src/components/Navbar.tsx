...
const Navbar = ({ onLoginOpen }: NavbarProps) => {
  ...
  const handleLoginOpen = onLoginOpen ?? (() => {});
        ...
        <Flex h={16} alignItems="center" flexWrap="wrap" gap={2}>
          ...
          <HStack spacing={{ base: 1, md: 3 }} flexWrap="wrap" justify="flex-end">
            ...
            {isAuthenticated && currentUser ? (
              <HStack spacing={2}>
                ...
                >
                  <Avatar
                    ...
                    src={currentUser.avatarUrl || currentUser.photoURL || undefined}
              ...
              <Button colorScheme="whiteAlpha" variant="ghost" color="white" onClick={handleLoginOpen} minH="44px">
                Login
              </Button>
            )}
            <Button
